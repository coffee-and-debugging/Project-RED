...
const ResetHosPass = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await axios.post(
        "http://127.0.0.1:8000/api/hospital-password-reset/confirm/",
        {
          token: `${uid}/${token}`,
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-cyan-200 via-white to-red-200 px-4">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-md">
        ...
        <button className="w-full mt-4 py-2 border border-cyan-600 text-cyan-700 font-semibold rounded-lg hover:bg-cyan-100 transition cursor-pointer">
          Back to Hospital Login
        </button>
